...
onScroll()
function onScroll(directory_con){
    var fixTop = $('.blogger-name-msg').offset().top
    $(window).scroll(function(){
        if($(window).scrollTop()>fixTop){
            $('.blogger-name-msg, .directoryBox').addClass('on')
        }else{
            $('.blogger-name-msg, .directoryBox').removeClass('on')
        }
    });
}
